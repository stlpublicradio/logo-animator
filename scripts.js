const makeLogo = (className = '') => `
  <svg class="logo ${className}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 35.47">
    <g class="logo-bars">
